...
We provide more parameters for which to correct the bias for `lm`, `glm`, `glm.nb` and `lmer` classes, as shown in the example above with the overdispersion parameter of the negative binomial regression.
